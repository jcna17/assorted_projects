...
targets = ["cam", "bd", "c4", "totem", "master", "dragon"] #keywords in titles of posts 
...
for index, row in masterlist.iterrows():
    ...
    if row.notification != True or row.notification != 1:
